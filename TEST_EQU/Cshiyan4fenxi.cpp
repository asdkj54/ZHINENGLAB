...
CString Cshiyan4fenxi::VariantToCString(_variant_t var)
{
...
void Cshiyan4fenxi::OnBnClickedButton1()
{
	...
	strSQL.Format(_T("select top 10 试验结果 from test4 order by 日期 desc"));
	...
	m_ChartCtrl41.SetZoomEnabled(true);
	m_ChartCtrl41.RemoveAllSeries();//先清空
	pLineSerie1 = m_ChartCtrl41.CreateLineSerie();
