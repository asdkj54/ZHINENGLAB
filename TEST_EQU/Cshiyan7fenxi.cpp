...
CString Cshiyan7fenxi::VariantToCString(_variant_t var)
{
...
void Cshiyan7fenxi::OnBnClickedButton1()
{
	...
	strSQL.Format(_T("select top 10 介损 from test7 order by 日期 desc"));
	...
	m_ChartCtrl71.SetZoomEnabled(true);
	m_ChartCtrl71.RemoveAllSeries();//先清空
	pLineSerie1 = m_ChartCtrl71.CreateLineSerie();
