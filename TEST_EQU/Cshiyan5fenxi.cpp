...
CString Cshiyan5fenxi::VariantToCString(_variant_t var)
{
...
void Cshiyan5fenxi::OnBnClickedButton1()
{
	...
	strSQL.Format(_T("select top 10 酸值 from test5 order by 日期 desc"));
	...
	m_ChartCtrl51.SetZoomEnabled(true);
	m_ChartCtrl51.RemoveAllSeries();//先清空
	pLineSerie1 = m_ChartCtrl51.CreateLineSerie();
