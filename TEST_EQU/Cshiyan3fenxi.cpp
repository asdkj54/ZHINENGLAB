...
CString Cshiyan3fenxi::VariantToCString(_variant_t var)
{
...
void Cshiyan3fenxi::OnBnClickedButton1()
{
	...
	strSQL.Format(_T("select top 10 微水含量 from test3 order by 日期 desc"));
	...
	m_ChartCtrl31.SetZoomEnabled(true);
	m_ChartCtrl31.RemoveAllSeries();//先清空
	pLineSerie1 = m_ChartCtrl31.CreateLineSerie();
