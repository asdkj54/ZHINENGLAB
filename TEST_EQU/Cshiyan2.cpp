...
HBRUSH Cshiyan2::OnCtlColor(CDC * pDC, CWnd * pWnd, UINT nCtlColor)
{
...
void Cshiyan2::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void Cshiyan2::OnBnClickedButton5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void Cshiyan2::OnBnClickedButton4()
{
	// TODO: 在此添加控件通知处理程序代码
	OnBnClickedopenGetFile();
}
void Cshiyan2::OnBnClickedopenGetFile()
{
	// 设置过滤器   
