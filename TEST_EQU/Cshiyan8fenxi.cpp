...
CString Cshiyan8fenxi::VariantToCString(_variant_t var)
{
...
void Cshiyan8fenxi::OnBnClickedButton1()
{
	...
	strSQL.Format(_T("select top 10 试验结果 from test8 order by 日期 desc"));
	...
	m_ChartCtrl81.SetZoomEnabled(true);
	m_ChartCtrl81.RemoveAllSeries();//先清空
	pLineSerie1 = m_ChartCtrl81.CreateLineSerie();
