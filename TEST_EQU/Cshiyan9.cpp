...
BEGIN_MESSAGE_MAP(Cshiyan9, CDialogEx)
	ON_WM_PAINT()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_BUTTON1, &Cshiyan9::OnBnClickedButton1)
...
HBRUSH Cshiyan9::OnCtlColor(CDC * pDC, CWnd * pWnd, UINT nCtlColor)
{
...
void Cshiyan9::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void Cshiyan9::OnBnClickedButton5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void Cshiyan9::OnBnClickedButton4()
{
	// TODO: 在此添加控件通知处理程序代码
	OnBnClickedopenGetFile();
}
void Cshiyan9::OnBnClickedopenGetFile()
{
	// 设置过滤器   
...
void Cshiyan9::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
