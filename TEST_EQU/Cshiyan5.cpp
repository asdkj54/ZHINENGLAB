...
BEGIN_MESSAGE_MAP(Cshiyan5, CDialogEx)
	ON_WM_PAINT()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_BUTTON1, &Cshiyan5::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON5, &Cshiyan5::OnBnClickedButton5)
	ON_BN_CLICKED(IDC_BUTTON4, &Cshiyan5::OnBnClickedButton4)
	ON_BN_CLICKED(IDC_BUTTON2, &Cshiyan5::OnBnClickedButton2)
	ON_BN_CLICKED(IDC_BUTTON3, &Cshiyan5::OnBnClickedButton3)
END_MESSAGE_MAP()
...
HBRUSH Cshiyan5::OnCtlColor(CDC * pDC, CWnd * pWnd, UINT nCtlColor)
{
...
void Cshiyan5::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void Cshiyan5::OnBnClickedButton5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void Cshiyan5::OnBnClickedButton4()
{
	// TODO: 在此添加控件通知处理程序代码
	OnBnClickedopenGetFile();
}
void Cshiyan5::OnBnClickedopenGetFile()
{
	// 设置过滤器   
...
void Cshiyan5::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
...
BOOL Cshiyan5::OnInitDialog()
{
	CDialogEx::OnInitDialog();

	// TODO:  在此添加额外的初始化
	// TODO: 在此添加额外的初始化代码
	dlg.Create(IDD_shiyan5report);
	dlg1.Create(IDD_shiyan5fenxi);
	return TRUE;  // return TRUE unless you set the focus to a control
				  // 异常: OCX 属性页应返回 FALSE
}


void Cshiyan5::OnBnClickedButton3()
{
	// TODO: 在此添加控件通知处理程序代码
