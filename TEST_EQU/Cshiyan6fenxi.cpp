...
CString Cshiyan6fenxi::VariantToCString(_variant_t var)
{
...
void Cshiyan6fenxi::OnBnClickedButton1()
{
	...
	strSQL.Format(_T("select top 10 闪点 from test6 order by 日期 desc"));
	...
	m_ChartCtrl61.SetZoomEnabled(true);
	m_ChartCtrl61.RemoveAllSeries();//先清空
	pLineSerie1 = m_ChartCtrl61.CreateLineSerie();
